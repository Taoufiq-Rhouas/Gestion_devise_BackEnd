...
const {signup,checkUserIsExistAndDeposit,getProfileInfo,getuserUnfo,getUserTotalAmount,checkUserTotalAmount,buyCrypto,sellCrypto} = require('../controllers/userController');
...
router.post('/sellCrypto/',getUserTotalAmount,sellCrypto);
