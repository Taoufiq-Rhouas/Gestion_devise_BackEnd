...
const {signup,checkUserIsExistAndDeposit,getProfileInfo,getuserUnfo,getUserTotalAmount,checkUserTotalAmount,buyCrypto} = require('../controllers/userController');
